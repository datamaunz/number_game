...
def main():
    ...
    1. Set the slider to the lowest number that has been put on the table. If no card is on the table yet, set it to 0. Set the card counter on the sidebar to the number of cards remaining in the game.
